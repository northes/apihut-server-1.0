...
func GetProxyIPFromKuaiNiao() (proxyIP string, err error) {
	...
	err = util.HttpGetRequest(
		"http://api.kuainiaoip.com/index.php?fetch_type=2021060901140657286&pool_id=&qty=1&time=100&province=%E6%89%80%E6%9C%89&city=%E6%89%80%E6%9C%89&protocol=1&format=json&dt=1",
		&p,
	)
	if err != nil {
		fmt.Println(err)
